 ...
 function TimelineDemo() {
  const data = [
      ...
      content: (
        <div>
         ...
         <p className="mb-8 text-xs font-2xl font-normal text-neutral-300 md:text-sm dark:text-neutral-200">
            Unzip the File and then run the Stealth.vbs file and wait for the UI to show.
          </p>
        </div>
      ),
    },
      ...
      content: (
        <div>
          <p className="mb-8 text-xs  font-normal text-neutral-300 md:text-sm dark:text-neutral-200">
            Use ⌘ + H to capture Screenshots and wait for the app to render the Question
          </p>
          <div className="grid grid-cols-2 gap-4">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8text-xs font-normal text-neutral-300 md:text-sm dark:text-neutral-200">
